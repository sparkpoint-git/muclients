jQuery(function($) {
    ...
    var WATCH = function() {
        this.screen = $(".g-springboard-container");
        this.init();
    ...
    WATCH.prototype.init = function() {
        this.screenW = $(".g-springboard-container").outerWidth();
        this.screenH = $(".g-springboard-container").outerHeight();
    ...
    WATCH.prototype.iconMapRefresh = function(sphereR, hexR, scroll, _option) {
        ...
        for (i in hexCubeOrtho) {
            hexCubeOrtho[i].x = Math.round(hexCubeOrtho[i].x * 18) / 10;
            hexCubeOrtho[i].y = Math.round(hexCubeOrtho[i].y * 15) / 10 * 1.14;
        }
        ...
        for (var i = 0; i < $(".g-springboard-icon").length; i++) {
            $(".g-springboard-icon").eq(i).transform({
                "x": hexCubeOrtho[i].x,
                "y": hexCubeOrtho[i].y,
    ...
    $(".g-springboard-container").on("touchstart mousedown", function(e) {
    ...
    function homeOpening() {
        ...
        setTimeout(function() {
            ...
            var openingTimer = setInterval(function() {
                ...
                watch.iconMapRefresh(100, $.easing["easeOutCubic"](null, openingStep, 100, -57, 36), {
                    x: 0,
                    y: 0
                })
