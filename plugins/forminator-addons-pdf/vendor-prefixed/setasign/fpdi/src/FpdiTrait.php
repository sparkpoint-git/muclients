...
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Filter\FilterException;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\PdfParser;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\PdfParserException;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\StreamReader;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfArray;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfBoolean;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfDictionary;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfHexString;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfIndirectObject;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfIndirectObjectReference;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfName;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfNull;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfNumeric;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfStream;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfString;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfToken;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfType;
use ForminatorPDFAddon\setasign\Fpdi\PdfParser\Type\PdfTypeException;
use ForminatorPDFAddon\setasign\Fpdi\PdfReader\DataStructure\Rectangle;
use ForminatorPDFAddon\setasign\Fpdi\PdfReader\PageBoundaries;
use ForminatorPDFAddon\setasign\Fpdi\PdfReader\PdfReader;
use ForminatorPDFAddon\setasign\Fpdi\PdfReader\PdfReaderException;
use ForminatorPDFAddon\setasign\FpdiPdfParser\PdfParser\PdfParser as FpdiPdfParser;
/**
 * The FpdiTrait
 *
