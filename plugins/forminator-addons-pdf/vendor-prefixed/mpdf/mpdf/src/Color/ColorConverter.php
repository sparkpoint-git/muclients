...
class ColorConverter
{
    ...
    private $cache;
    public function __construct(Mpdf $mpdf, \Mpdf\Color\ColorModeConverter $colorModeConverter, \Mpdf\Color\ColorSpaceRestrictor $colorSpaceRestrictor)
    {
        $this->mpdf = $mpdf;
    ...
    public function convert($color, array &$PDFAXwarnings = [])
    {
        ...
        if (isset(\Mpdf\Color\NamedColors::$colors[$color])) {
            $color = \Mpdf\Color\NamedColors::$colors[$color];
        }
