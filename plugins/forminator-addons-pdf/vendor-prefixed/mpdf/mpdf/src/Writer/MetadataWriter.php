...
class MetadataWriter implements \ForminatorPDFAddon\Psr\Log\LoggerAwareInterface
{
    use Strict;
     ...
     */
    private $protection;
    public function __construct(Mpdf $mpdf, \Mpdf\Writer\BaseWriter $writer, Form $form, Protection $protection, LoggerInterface $logger)
    {
        $this->mpdf = $mpdf;
        $this->writer = $writer;
        $this->form = $form;
