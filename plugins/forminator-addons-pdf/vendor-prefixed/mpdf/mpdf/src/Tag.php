...
class Tag
{
     ...
     */
    public function __construct(\Mpdf\Mpdf $mpdf, \Mpdf\Cache $cache, \Mpdf\CssManager $cssManager, \Mpdf\Form $form, \Mpdf\Otl $otl, \Mpdf\TableOfContents $tableOfContents, \Mpdf\SizeConverter $sizeConverter, ColorConverter $colorConverter, ImageProcessor $imageProcessor, LanguageToFontInterface $languageToFont)
    {
        $this->mpdf = $mpdf;
        $this->cache = $cache;
