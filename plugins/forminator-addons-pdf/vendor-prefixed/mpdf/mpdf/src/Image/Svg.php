...
class Svg
{
    ...
    private $inDefs;
    public function __construct(Mpdf $mpdf, Otl $otl, CssManager $cssManager, \Mpdf\Image\ImageProcessor $imageProcessor, SizeConverter $sizeConverter, ColorConverter $colorConverter, LanguageToFontInterface $languageToFont, ScriptToLanguageInterface $scriptToLanguage)
    {
        $this->mpdf = $mpdf;
        $this->otl = $otl;
