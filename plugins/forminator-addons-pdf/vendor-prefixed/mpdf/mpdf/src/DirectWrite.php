...
class DirectWrite
{
    ...
    public function __construct(\Mpdf\Mpdf $mpdf, \Mpdf\Otl $otl, \Mpdf\SizeConverter $sizeConverter, ColorConverter $colorConverter)
    {
        $this->mpdf = $mpdf;
        $this->otl = $otl;
                ...
                if ($l > $wmax) {
                    ...
                    if ($sep == -1) {
                        ...
                        if ($align === 'J') {
                            ...
                            list($charspacing, $ws) = $this->mpdf->GetJspacing($nb_carac, $nb_spaces, ($w - 2 - $len_ligne) * \Mpdf\Mpdf::SCALE, $inclCursive);
                ...
                if ($l > $wmax) {
                    ...
                    if ($sep == -1) {
                        ...
                        if ($align === 'J') {
                            ...
                            list($charspacing, $ws) = $this->mpdf->GetJspacing($nb_carac, $nb_spaces, ($w - 2 - $len_ligne) * \Mpdf\Mpdf::SCALE, $false);
                            $this->mpdf->SetSpacing($charspacing, $ws);
                            //////////////////////////////////////////
                        }
                        $this->mpdf->Cell($w, $h, $tmp, 0, 2, $align, $fill, $link);
