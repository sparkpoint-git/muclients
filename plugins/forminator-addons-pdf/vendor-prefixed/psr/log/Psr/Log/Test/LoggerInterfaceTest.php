...
namespace ForminatorPDFAddon\Psr\Log\Test;

use ForminatorPDFAddon\Psr\Log\LoggerInterface;
use ForminatorPDFAddon\Psr\Log\LogLevel;
use ForminatorPDFAddon\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('ForminatorPDFAddon\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('ForminatorPDFAddon\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('ForminatorPDFAddon\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
