 ...
 */
class Shipper_Controller_Override_Migration_Tables extends Shipper_Controller_Override_Migration {
	...
	public function get_scope() {
		return Shipper_Model_Stored_MigrationMeta::KEY_EXCLUSIONS_DB;
	}
	...
	public function apply_overrides() {
		...
		if ( $this->get_model()->is_extract_mode() ) {
			 ...
			 * @since 1.2.4
			 */
			add_action( 'shipper_before_dump_table_for_api_migration', array( $this, 'transform_table' ) );
		}
