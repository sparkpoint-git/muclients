<?php
/**
 * Auto loader for WPMUDEV Videos.
 *
 * @link     https://wpmudev.com
 * @since    1.8.0
 *
 * @authors  Joel James <joel@incsub.com>, Tom McFarlin
...
spl_autoload_register( 'wpmudev_videos_auto_loader' );

/**
 * Dynamically loads the class attempting to be instantiated elsewhere in the
 * plugin by looking at the $class_name parameter being passed as an argument.
 *
 * The argument should be in the form: WPMUDEV_Videos\Namespace. The
 ...
 * @since 1.0.0
 */
function wpmudev_videos_auto_loader( $class_name ) {
	// If the specified $class_name does not include our namespace, duck out.
	if ( false === strpos( $class_name, 'WPMUDEV_Videos' ) ) {
		return;
	}
