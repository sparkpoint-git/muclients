...
<div class="uabb-module-content uabb-imgseparator-wrap">
	...
	<a class="imgseparator-link" href="<?php echo esc_url( $settings->link ); ?>" target="<?php echo esc_attr( $settings->link_target ); ?>" <?php BB_Ultimate_Addon_Helper::get_link_rel( $settings->link_target, 0, 1 ); ?> aria-label="<?php echo esc_attr( 'Learn more - ' . $alt ); ?>"></a>
	<?php endif; ?>
