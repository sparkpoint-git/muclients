...
<div class="uabb-module-content uabb-ib1-outter">
	...
	<a href="<?php echo $settings->cta_link; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" target="<?php echo esc_attr( $settings->cta_link_target ); ?>" <?php BB_Ultimate_Addon_Helper::get_link_rel( $settings->cta_link_target, $nofollow, 1 ); ?>>
	<?php endif; ?>
